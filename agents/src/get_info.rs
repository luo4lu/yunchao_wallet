...
pub async fn get_agents_list(
    ...
    for value in agents_select.iter(){
        ...
        let begin_timestamp: NaiveDateTime = value.get(6);
        let end_timestamp: NaiveDateTime = value.get(7);
        let params: AgentsResponse = AgentsResponse {
            ...
            begin_time: begin_timestamp.timestamp(),
            end_time: end_timestamp.timestamp(),
